...
---
# Data Organization
All datasets are currently being moved to SCC. 
...
For small stuff (e.g. tabular data) you can make temporary copies to the `/18TB/Datasets` directory on `echo`, which is also accessible as `/18TB_echo/Datasets` from `ayan` and `manu`. 
