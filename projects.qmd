...
Learning on MRIs with missing sequences: Diala, Divya
...
Predicting biomarker status for biological AD: Varuna, Sahana, Shreyas, Lingyi, Mike
...
Foundation model for the assessment of ADRD: Sahana, Matteo, Varuna, Shreyas, Lingyi, Meagan, Ketan
    - take multimodal data, routinely collected (text, MRI, EEG), build a virtual assistant for neurology

Speech deidentification while preserving cognitive utility: Meysam, Cody 
    - anonymize speech data while keeping enough audio features to estimate cognitive impairment

PodGPT: Shuyue, Subh, Ned, Varuna, Meagan, Lindsey, Divya
    - augment performance of LLM with STEM information, from written, audio, and video sources. We have a product online.

LLM grounding: Yi Liu, Krish

Identification of tissue neighborhoods in colorectal cancer: Yichi

Fusion of acoustic and language features for cognitive assessment: Abhi, Serena

Predicting cognitive status from reaction time: Matteo, Meagan

Sleep and digital brain health: Matteo

AI augmented neuroradiologist: Shreyas, Krish, Olivia, Mike

Vision-language model for predicting biomarkers: Yi Zheng, Divya
...
Effect of drug toxicity on systemic circulation: Aubrey, Yichi
